...
const STATUS_BADGE = { pending:'badge-yellow',reviewing:'badge-purple',shortlisted:'badge-green',rejected:'badge-red',hired:'badge-green' };
        ...
        <div style={{ display:'flex',flexDirection:'column',gap:16 }}>
          {applications.map(app => {
            ...
            const salary = job?.salaryMin && job?.salaryMax
              ? `$${(job.salaryMin/1000).toFixed(0)}k – $${(job.salaryMax/1000).toFixed(0)}k` : null;
            return (
              <div key={app._id} className="card" style={{ display:'flex',justifyContent:'space-between',gap:20,alignItems:'flex-start',flexWrap:'wrap' }}>
                <div style={{ flex:1 }}>
                ...
                <div style={{ flexShrink:0,textAlign:'right' }}>
                  ...
                  <p style={{ color:'#888899',fontSize:12 }}>
